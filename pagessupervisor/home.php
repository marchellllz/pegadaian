                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <a href="editprofile/editprofile.php" class="position-relative">
                            <img src="../assets/profil.jpeg" alt="profil" class="rounded-circle border border-3 border-success"
            ...
            <div class="col-12 col-md-6">
                <div class="card border-0 shadow h-100" style="border-radius: 20px; background: rgba(255, 255, 255, 0.95); backdrop-filter: blur(10px);">
                    <div class="card-body text-center py-5 position-relative">
                        ...
                        <h5 class="card-title fw-bold mb-3 text-dark">Lihat Data Karyawan</h5>
                        <p class="text-muted mb-4">Kelola dan pantau data karyawan aktif dalam sistem perusahaan</p>
                        <a href="datakaryawan/datakaryawan.php" class="btn btn-primary px-5 py-3 rounded-pill fw-semibold">
                            <i class="fas fa-eye me-2"></i>Lihat Karyawan
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-md-6">
                <div class="card border-0 shadow h-100" style="border-radius: 20px; background: rgba(255, 255, 255, 0.95); backdrop-filter: blur(10px);">
                    <div class="card-body text-center py-5">
                        ...
                        <h5 class="card-title fw-bold mb-3 text-dark">Kebijakan Bunga</h5>
                        <p class="text-muted mb-4">Atur dan kelola tingkat suku bunga untuk berbagai produk keuangan</p>
                        <?php if ($_SESSION['cabang'] === 'mataram') {
                            echo '<a href="bunga/bunga.php" class="btn btn-warning px-5 py-3 rounded-pill fw-semibold text-dark">
            <i class="fas fa-chart-line me-2"></i>Kelola Bunga
          </a>';
                        } else {
                            echo '<div class="alert alert-danger mt-3">
            <i class="fas fa-ban me-2"></i>Kebijakan bunga hanya dapat diubah oleh pusat
          </div>';
                        } ?>
                    </div>
                </div>
            ...
            <div class="col-12 col-md-6">
                <div class="card border-0 shadow h-100" style="border-radius: 20px; background: rgba(255, 255, 255, 0.95); backdrop-filter: blur(10px);">
                    <div class="card-body text-center py-5">
                        ...
                        <a href="aktivitas_gadai/datagadai.php" class="btn btn-info px-5 py-3 rounded-pill fw-semibold text-white">
            ...
            <div class="col-12 col-md-6">
                <div class="card border-0 shadow h-100" style="border-radius: 20px; background: rgba(255, 255, 255, 0.95); backdrop-filter: blur(10px);">
                    <div class="card-body text-center py-5">
                        ...
                        <p class="text-muted mb-4">Pantau dan verifikasi semua aktivitas pembayaran nasabah</p>
                        <a href="aktivitas_pembayaran/home_payment.php" class="btn btn-success px-5 py-3 rounded-pill fw-semibold">
            ...
            <div class="card border-0 shadow-sm" style="border-radius: 15px; background: rgba(255, 255, 255, 0.8);">
                <div class="card-body py-3">
                    <small class="text-muted">
                        ...
                        Dashboard Supervisor - Sobat Gadai
                    </small>
                </div>
            </div>
        </div>
