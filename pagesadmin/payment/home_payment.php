...
session_start();
if (!isset($_SESSION['usr']) || !isset($_SESSION['role']) || $_SESSION['role'] !== 'admin' || !isset($_SESSION['cabang'])) {
...
<head>
    ...
    <title>Home Payment - Admin Dashboard</title>
            ...
            <div class="header-section">
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
                    <div>
                        ...
                        <p class="header-subtitle">Kelola dan pantau semua transaksi pembayaran</p>
                    </div>
                    <div class="action-buttons d-flex flex-column flex-md-row mt-3 mt-md-0">
                        <a href="payment_form.php" class="btn btn-success me-2">
                            <i class="fas fa-plus me-2"></i>Tambah Pembayaran
                        </a>
                        <a href="return_form.php" class="btn btn-warning me-2">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><i class="fas fa-info-circle me-2"></i>Detail Pembayaran</h5>
